...
Get-AzVM -ResourceGroupName "RG-CoreNFT2.34" -Name corenftibmmqvm -AzContext $mycontext| Stop-AzVM -Force
Stop-AzAksCluster -Name Corenft-aks -ResourceGroupName RG-CoreNFT2.34
